// File: tests/Dataverse.Client.Tests/TestInfrastructure/InfrastructureTests.cs
...
/// <summary>
/// Tests for test infrastructure and data helpers.
/// </summary>
[TestFixture]
public class InfrastructureTests
{
    ...
    #region Test Data Infrastructure Tests
    ...
    #region Mock ServiceClient Helper Tests

    [Test]
    public void MockServiceClientHelper_CreateMockOrganizationService_ShouldWorkCorrectly()
    {
        // Act
        var mockOrgService = MockServiceClientHelper.CreateMockOrganizationService();

        // Assert
        mockOrgService.Should().NotBeNull();
        mockOrgService.Object.Should().NotBeNull();
    }

    [Test]
    public void MockServiceClientHelper_CreateMockWithExecuteSupport_ShouldSupportBasicOperations()
    {
        // Arrange
        var mockOrgService = MockServiceClientHelper.CreateMockWithExecuteSupport();
        
        // Act & Assert - Test Create
        var createResponse = mockOrgService.Object.Execute(new Microsoft.Xrm.Sdk.Messages.CreateRequest 
        { 
            Target = TestEntities.CreateTestContact() 
        });
        createResponse.Should().NotBeNull();
        
        // Act & Assert - Test WhoAmI
        var whoAmIResponse = mockOrgService.Object.Execute(new Microsoft.Crm.Sdk.Messages.WhoAmIRequest());
